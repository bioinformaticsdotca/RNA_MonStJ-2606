...
# Module 1: Intro to RNAseq concepts, inputs and QC
...
The libraries are prepared as paired-end reads.  
The samples were sequenced on an **Illumina HiSeq 4000** platform, with reads of **150 bp** in length.  

👉 [GSE114360](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA471072)

- 3 samples transfected with target shRNA  
- 3 samples with control shRNA  
